...
<script src="../assets/desinscribir.js"></script>
<form  method="POST">
    ...
    ?>
    <h3>Ingrese el DNI de la persona a Desinscribir</h3>
  ...
  <button class="btn btn-primary" type="button" onclick="enviar_form();">Desinscribir</button>
